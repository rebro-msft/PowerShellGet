...
function SuiteSetup {
    ...
    $script:DscResourceInPrereleaseModule = "DscTestResource"
    $script:RoleCapabilityInPrereleaseModule = "Lev1Maintenance"
...
Describe InstallSaveModulePrereleaseTests -Tags "TDD" {
    ...
    It "PipeFindToInstallModuleByNameAllowPrerelease" {
        ...
        $res.Version | Should Match $script:PrereleaseModuleLatestPrereleaseVersion
    ...
    It "PipeFindCommandToInstallModuleByNameAllowPrerelease" {
        Find-Command -Name $script:CommandInPrereleaseModule -ModuleName $script:DscTestModule -Repository Local -AllowPrerelease | Install-Module
        $res = Get-InstalledModule -Name $script:DscTestModule

        $res | Should Not Be $null
        $res | Measure-Object | ForEach-Object { $_.Count } | Should Be 1
        $res.Name | Should Be $script:DscTestModule
        $res.Version | Should Match $script:DscTestModuleLatestVersion
        $res.AdditionalMetadata | Should Not Be $null
        $res.AdditionalMetadata.IsPrerelease | Should Match "true"
    }

    It "PipeFindCommandToInstallModuleSpecificPrereleaseVersionByNameWithAllowPrerelease" {
        Find-Command -Name $script:CommandInPrereleaseModule -ModuleName $script:DscTestModule -Repository Local -AllowPrerelease -RequiredVersion "2.0.0-beta200" | Install-Module
        $res = Get-InstalledModule -Name $script:DscTestModule
    ...
    It "PipeFindCommandToInstallModuleSpecificPrereleaseVersionByNameWithoutAllowPrerelease" {
        $script = {
            Find-Command -Name $script:CommandInPrereleaseModule -ModuleName $script:DscTestModule -Repository Local -RequiredVersion "2.0.0-beta200" | Install-Module
        }
        $script | Should Throw
    }

    It "PipeFindDscResourceToInstallModuleByNameAllowPrerelease" {
        Find-DscResource -Name $script:DscResourceInPrereleaseModule -ModuleName $script:DscTestModule -AllowPrerelease -Repository Local | Install-Module
        $res = Get-InstalledModule -Name $script:DscTestModule
    ...
    It "PipeFindDscResourceToInstallModuleSpecificPrereleaseVersionByNameWithAllowPrerelease" {
        Find-DscResource -Name $script:DscResourceInPrereleaseModule -ModuleName $script:DscTestModule -RequiredVersion "2.0.0-beta200" -AllowPrerelease -Repository Local | Install-Module
        $res = Get-InstalledModule -Name $script:DscTestModule
    ...
    It "PipeFindDscResourceToInstallModuleSpecificPrereleaseVersionByNameWithoutAllowPrerelease" {
        $script = {
            Find-DscResource -Name $script:DscResourceInPrereleaseModule -ModuleName $script:DscTestModule -RequiredVersion "2.0.0-beta200" -Repository Local | Install-Module
        }
        $script | Should Throw
    }

    It "PipeFindRoleCapabilityToInstallModuleByNameAllowPrerelease" {
        Find-RoleCapability -Name $script:RoleCapabilityInPrereleaseModule -ModuleName $script:DscTestModule -AllowPrerelease -Repository Local | Install-Module
        $res = Get-InstalledModule -Name $script:DscTestModule
    ...
    It "PipeFindRoleCapabilityToInstallModuleSpecificPrereleaseVersionByNameWithAllowPrerelease" {
        Find-RoleCapability -Name $script:RoleCapabilityInPrereleaseModule -ModuleName $script:DscTestModule -RequiredVersion "2.0.0-beta200" -AllowPrerelease -Repository Local | Install-Module
        $res = Get-InstalledModule -Name $script:DscTestModule
    ...
    It "PipeFindRoleCapabilityToInstallModuleSpecificPrereleaseVersionByNameWithoutAllowPrerelease" {
        $script = {
            Find-RoleCapability -Name $script:RoleCapabilityInPrereleaseModule -ModuleName $script:DscTestModule -RequiredVersion "2.0.0-beta200" -Repository Local | Install-Module
        }
        $script | Should Throw
    }
    ...
    It "InstallPrereleaseModuleByName" {
        ...
        $res.Name | Should Be $script:PrereleaseModuleName
        $res.Version | Should Be $script:PrereleaseModuleLatestPrereleaseVersion
    }
    ...
    It "PipeFindToSaveModuleByNameAllowPrerelease" {
        Find-Module -Name $script:PrereleaseModuleName -AllowPrerelease -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        $res = Get-InstalledModule -Name $script:PrereleaseModuleName
    ...
    It "PipeFindToSaveModuleSpecificPrereleaseVersionByNameWithAllowPrerelease" {
        Find-Module -Name $script:PrereleaseModuleName -RequiredVersion "2.0.0-beta500" -AllowPrerelease -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        $res = Get-InstalledModule -Name $script:PrereleaseModuleName
    ...
    It "PipeFindToSaveModuleSpecificPrereleaseVersionByNameWithoutAllowPrerelease" {
        $script = {
            Find-Module -Name $script:PrereleaseModuleName -RequiredVersion "2.0.0-beta500" -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        }
        $script | Should Throw
    }
    
    It "PipeFindCommandToSaveModuleByNameAllowPrerelease" {
        Find-Command -Name $script:CommandInPrereleaseModule -ModuleName $script:DscTestModule -AllowPrerelease -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        $res = Get-InstalledModule -Name $script:DscTestModule
    ...
    It "PipeFindCommandToSaveModuleSpecificPrereleaseVersionByNameWithAllowPrerelease" {
        Find-Command -Name $script:CommandInPrereleaseModule -ModuleName $script:DscTestModule -RequiredVersion "2.0.0-beta200" -AllowPrerelease -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        $res = Get-InstalledModule -Name $script:DscTestModule
    ...
    It "PipeFindCommandToSaveModuleSpecificPrereleaseVersionByNameWithoutAllowPrerelease" {
        $script = {
            Find-Command -Name $script:CommandInPrereleaseModule -ModuleName $script:DscTestModule -RequiredVersion "2.0.0-beta200" -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        }
        $script | Should Throw
    }

    It "PipeFindDscResourceToSaveModuleByNameAllowPrerelease" {
        Find-DscResource -Name $script:DscResourceInPrereleaseModule -ModuleName $script:DscTestModule -AllowPrerelease -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        $res = Get-InstalledModule -Name $script:DscTestModule
    ...
    It "PipeFindDscResourceToSaveModuleSpecificPrereleaseVersionByNameWithAllowPrerelease" {
        Find-DscResource -Name $script:DscResourceInPrereleaseModule -ModuleName $script:DscTestModule -RequiredVersion "2.0.0-beta200" -AllowPrerelease -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        $res = Get-InstalledModule -Name $script:DscTestModule
    ...
    It "PipeFindDscResourceToSaveModuleSpecificPrereleaseVersionByNameWithoutAllowPrerelease" {
        $script = {
            Find-DscResource -Name $script:DscResourceInPrereleaseModule -ModuleName $script:DscTestModule -RequiredVersion "2.0.0-beta200" -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        }
        $script | Should Throw
    }

    It "PipeFindRoleCapabilityToSaveModuleByNameAllowPrerelease" {
        Find-RoleCapability -Name $script:RoleCapabilityInPrereleaseModule -ModuleName $script:DscTestModule -AllowPrerelease -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        $res = Get-InstalledModule -Name $script:DscTestModule
    ...
    It "PipeFindRoleCapabilityToSaveModuleSpecificPrereleaseVersionByNameWithAllowPrerelease" {
        Find-RoleCapability -Name $script:RoleCapabilityInPrereleaseModule -ModuleName $script:DscTestModule -RequiredVersion "2.0.0-beta200" -AllowPrerelease -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        $res = Get-InstalledModule -Name $script:DscTestModule
    ...
    It "PipeFindRoleCapabilityToSaveModuleSpecificPrereleaseVersionByNameWithoutAllowPrerelease" {
        $script = {
            Find-RoleCapability -Name $script:RoleCapabilityInPrereleaseModule -ModuleName $script:DscTestModule -RequiredVersion "2.0.0-beta200" -Repository Local | Save-Module -LiteralPath $script:MyDocumentsModulesPath
        }
        $script | Should Throw
    }
    ...
    It "SavePrereleaseModuleByName" {
        Save-Module -Name $script:PrereleaseModuleName -AllowPrerelease -Repository Local -LiteralPath $script:MyDocumentsModulesPath
        $res = Get-InstalledModule -Name $script:PrereleaseModuleName -AllowPrerelease
    ...
    It "SaveSpecificPrereleaseModuleVersionByNameWithAllowPrerelease" {
        Save-Module -Name $script:PrereleaseModuleName -RequiredVersion "2.0.0-beta500" -AllowPrerelease -Repository Local -LiteralPath $script:MyDocumentsModulesPath
        $res = Get-InstalledModule -Name $script:PrereleaseModuleName -AllowPrerelease
    ...
    It "SaveSpecificPrereleaseModuleVersionByNameWithoutAllowPrerelease" {
        $script = {
            Save-Module -Name $script:PrereleaseModuleName -RequiredVersion "2.0.0-beta500" -Repository Local -LiteralPath $script:MyDocumentsModulesPath
        }
        $script | Should Throw
    }
