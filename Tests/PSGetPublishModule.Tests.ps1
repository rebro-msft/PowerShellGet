...
Describe PublishModulePreReleaseTests -Tags 'TDD' {
    ...
    #
    # Action: Publish-Module [path]
    #
    # Expected Result: Publish-Module should throw InvalidCharactersInPrereleaseString errorid.
    #
...
"@
    ...
    # Purpose: Publish a module with an Prerelease string when the version has insufficient parts.
    #
    # Action: Publish-Module [path] 
    #
    # Expected Result: Publish-Module should throw IncorrectVersionPartsCountForPrereleaseStringUsage errorid.
    #
...
"@
    ...
    # Purpose: Publish a module with an Prerelease string when the version has too many parts.
    #
    # Action: Publish-Module [path] 
    #
    # Expected Result: Publish-Module should throw IncorrectVersionPartsCountForPrereleaseStringUsage errorid.
...
"@
    ...
    # Purpose: Publish a module with a valid Prerelease string and a version with sufficient parts.
    #
    # Action: Publish-Module [path] 
    #
    # Expected Result: Publish-Module should successfully validate the version field.
    #
